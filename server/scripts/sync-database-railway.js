/**
 * Script to sync all database models in Railway database, dropping and recreating the tables
 * 
 * Usage: node sync-database-railway.js
 * 
...
async function syncDatabase() {
  console.log('Starting database sync for Railway database...');
  try {
    ...
    console.log('All done! The Railway database is now set up.');
  } catch (error) {
